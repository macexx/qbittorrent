...
wget https://raw.githubusercontent.com/macexx/ubuntu-builds/master/qbittorrent/qbittorrent-nox_3.3.3-1_amd64.deb
dpkg -i libtorrent-rasterbar_1.0.7-1_amd64.deb
dpkg -i qbittorrent-nox_3.3.3-1_amd64.deb
